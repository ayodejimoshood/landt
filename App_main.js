...
const BottomTabNavigator = createBottomTabNavigator({
  TweetStack: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: <Feather name="home" size={20} color="#8e7aea" />,
    },
  },
  Search: {
    screen: SearchScreen,
    navigationOptions: {
      ...
      tabBarIcon: <Feather name="search" size={20} color="#636E72" />,
    },
  },
  Notification: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: <Feather name="bell" size={20} color="#636E72" />,
    },
  },
  Message: {
    screen: messageFlow,
    navigationOptions: {
      ...
      tabBarIcon: <Feather name="mail" size={20} color="#636E72" />,
    },
  },
});
...
const DrawerNavigator = createDrawerNavigator(
  {
    ...
    Bookmarks: { screen: HomeScreen },
    Moments: { screen: HomeScreen },
