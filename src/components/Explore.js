  ...
  return (
    ...
    <View>
      ...
      <ScrollView
        ...
        style={{ 
   flex: 1,  margin: 0, marginRightx: 10, paddingHorizontal: 0, position: 'absolute', bottomx: 0, top: 60, height: 200, marginBottomx: -200, widthx: '100%', textAlign: 'center', alignSelf: 'center', borderRadiusx: 45 }}
      >
            ...
            > */}
              ...
              >
                <Image
                  ...
                  style={{ height: 80, width: 80, top: -7 }}
                />
                <Text style={{alignSelf: 'center', fontSize: 14, fontWeight: 'bold', color: '#043F7C', marginBottomx: -15, top: -7}}>Social</Text>
              </View>
            {/* </ImageBackground> */}
          </TouchableOpacity>
          ...
          <TouchableOpacity>
            ...
            > */}
              ...
              <Image
                  ...
                  style={{ height: 80, width: 80, top: -7 }}
                />
                <Text style={{alignSelf: 'center', fontSize: 14, fontWeight: 'bold', color: '#043F7C', marginTopx: -15, top: -7}}>Marketplace</Text>
              </View>
              {/* </ImageBackground> */}
            </TouchableOpacity>
            ...
            <TouchableOpacity>
              ...
              > */}
                ...
                <Image
                  ...
                  style={{ height: 80, width: 80, top: -7 }}
                />
                  <Text style={{alignSelf: 'center', fontSize: 14, fontWeight: 'bold', color: '#043F7C', marginTopx: 5, top: -7}}>Charity</Text>
                </View>
              {/* </ImageBackground> */}
            </TouchableOpacity>
